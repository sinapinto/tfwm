...
OBJ= tfwm.o util.o events.o client.o list.o workspace.o keys.o
...
tfwm.o: tfwm.c list.h client.h workspace.h events.h keys.h
...
keys.o: keys.c tfwm.h list.h client.h events.h workspace.h
